      ...
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-md">
          ...
          <div className="mt-6 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-10 xl:px-24 xl:max-w-2xl">
            <h2
              className="text-center text-4xl text-blue-400 font-display font-semibold 
            ...
            <div className="mt-8">
              ...
              <div className="mt-5 pb-5 cursor-pointer text-blue-400 hover:text-blue-500 text-sm font-display font-bold text-center">
